...
Web links in messages and transcripts are clickable and open in a new tab. Email links open your configured email app. Captured link destinations are preserved; plain-text HTTP, HTTPS, `www.`, and email addresses are linked automatically. Linked websites are not downloaded into the archive.
...
- **0.3.5:** preserve clickable email links and link plain email addresses in messages and transcripts.
