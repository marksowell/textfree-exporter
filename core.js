(function(root){
  ...
  function extract(doc, url) {
    ...
    for(const node of container.children){
      ...
      if(kind==='voicemail'&&!record.attachments.some(a=>a.kind==='audio'))record.warnings.push('Voicemail audio is not exposed in the page; transcript only. Save audio separately.');
  ...
  root.TFCore={extract,escape,report,render,zip,crc32};
